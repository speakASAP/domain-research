# Copilot Instructions — `domain-research`
...
- **Authoritative path**: `/home/ssf/Documents/Github/domain-research` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/domain-research.git`, branch `main`.
...
3. This repo, in order: `BUSINESS.md` `SYSTEM.md` `AGENTS.md` `AGENT_OPERATIONS.md` `TASKS.md` `STATE.json`
