...
- domain suggestion, availability, and watch workflows described in the IPS adoption profile
- validation and governance workflow updated to match the repo’s operational scope


## Handoff

- service ownership remains within domain-research for domain lifecycle logic; payment and delivery infrastructure remain separate platform boundaries
